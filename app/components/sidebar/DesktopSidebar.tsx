...
export const DesktopSidebar = ({user} : {user : User | null}) => {
  ...
  return (
    <div className='lg:py-8 lg:px-4 xl:px-4 fixed lg:left-0 lg:flex lg:w-20 lg:flex-col lg:justify-between lg:items-center lg:h-full bg-white'>
        ...
        <div className='flex flex-col gap-4 items-center'>
          ...
          <DesktopSidebarItem icon={HiLogout} onClick={()=>signOut()} label="logout" href="/" />
        </div>
    </div>
  )
}
