        ...
        <div className="flex min-h-full items-center justify-center p-4 text-center">
          ...
          >
            <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-sm bg-white text-left align-middle shadow-xl transition-all">
              <Dialog.Title
                as="h3"
                className="text-lg font-medium leading-6 text-white bg-indigo-950 py-2 px-6 rounded-bl-2xl rounded-br-2xl"
              >
                Upload Picture
              </Dialog.Title>
              <div className='p-6'>
                <div className='mt-6 w-full flex flex-col gap-4 items-center'>
                    <div className="relative h-24 w-24 rounded-full overflow-hidden">
                        {image && <Image src={image} alt={"Avatar"} fill className='object-cover'/>}
                    </div>
                ...
                <div className="mt-12 w-full flex justify-end gap-4">
                    {
                        ...
                        <LoadingButton
                          ...
                          className="inline-flex justify-center rounded-md border border-transparent bg-blue-100 px-4 py-2 text-sm font-medium text-blue-600 hover:bg-blue-200"
                        >
                          Confirm
                        </LoadingButton>
                        </>
