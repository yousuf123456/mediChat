...
export function Drawer({ conversation } : DrawerProps) {
    ...
    const handleClick = ()=>{
        setIsLoading(true);
        axios.post(`/api/conversation/${conversationId}/delete`)
        .then(()=>{
  ...
  return (
      <SheetContent position="right" className="w-full min-[420px]:max-w-xl sm:max-w-sm">
        ...
        <SheetDescription>
            <div className="w-full flex flex-col justify-center items-center">
                <p className={clsx("font-medium text-indigo-950", conversation.name ? "text-xl" : "text-base")}>
        ...
        <div className="mt-12 flex flex-col gap-4">
            {
                !conversation.isGroup && (
                    ...
                    <div className="pl-2 flex flex-col">
                        ...
                        <p className="text-sm sm:text-base font-medium text-indigo-950">
                            { otherUser.email }
                        </p>
                    </div>
            ...
            <div className="pl-2 flex flex-col">
                ...
                <p className="text-sm lg:text-base font-medium text-indigo-950">
        ...
        <div className="mt-12 flex w-full justify-end px-2">
            <AlertDialog open={open}>
                <LoadingButton variant="destructive" onClick={()=>setOpen(true)}>Delete</LoadingButton>
                ...
                <AlertDialogContent className="pt-0 px-0">
                    ...
                    <AlertDialogFooter className="px-6 mt-4">
                        <LoadingButton variant={"outline"} disabled={isLoading} onClick={()=>setOpen(false)}>Cancel</LoadingButton>
                        <LoadingButton 
                            onClick={handleClick} 
                            disabled={isLoading} 
                            isLoading={isLoading} 
